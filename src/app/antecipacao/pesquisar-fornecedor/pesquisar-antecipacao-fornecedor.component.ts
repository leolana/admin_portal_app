...
export class PesquisarAntecipacaoFornecedorComponent implements OnInit {
    ...
    hasError = {
        dataSolicitacaoInicio: () => {
            ...
            if ((dataSolicitacaoInicio && dataSolicitacaoFim)
        ...
        this.antecipacaoService
            ...
            .subscribe(data => {
                ...
                this.table.forEach(antecipacao => {
                    antecipacao.dataAntecipacaoIso = DateTime.fromISO(antecipacao.dataAntecipacao).toFormat('dd/MM/yyyy');
                    antecipacao.dataPagamentoIso = DateTime.fromISO(antecipacao.dataPagamento).toFormat('dd/MM/yyyy');
