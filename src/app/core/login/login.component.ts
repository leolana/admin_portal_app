...
export class LoginComponent implements OnInit {
  ...
  signin() {
    ...
    this.authService.signin(this.login.value).subscribe(participantes => {
      ...
      if (participantes.length) this.participante.setValue(participantes[0].id);
  ...
  getSessionToken() {
    this.authService.getSessionToken(this.participante.value).subscribe(() => {
