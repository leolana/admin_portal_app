...
export class MenuComponent implements OnInit, OnDestroy {
  constructor(public auth: AuthService, private router: Router, private menuService: MenuService) {}
  ...
  updateExportProfile() {
    if (this.auth.user.participanteEstabelecimento || this.auth.user.participanteFornecedor) {
      this.menuService
        .getExportPermission()
  ...
  authBackOffice() {
    return this.auth.hasRole(this.roles.boAdministrador, this.roles.boOperacoes);
  }
