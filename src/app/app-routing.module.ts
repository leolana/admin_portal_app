...
import { PesquisarAntecipacaoEstabelecimentoComponent } from './antecipacao/pesquisar-estabelecimento/pesquisar-antecipacao-estabelecimento.component';
...
import { EditarIndicacaoEstabelecimentoComponent } from './fornecedor/indicacao-estabelecimento/editar/editar-indicacao-estabelecimento.component';
    ...
    children: [
      ...
      },
      {
        ...
        data: {
          somenteEstabelecimentos: true,
          somenteFornecedores: true,
          breadcrumb: [{ label: 'Consulta', path: '/cessoes' }, { label: 'Cessão' }],
        },
        canActivate: [ParticipanteGuard],
      },
      {
      ...
      },
      {
        ...
        data: {
          roles: [Roles.boAdministrador, Roles.ecAdministrador, Roles.fcAdministrador],
          breadcrumb: [{ label: 'Consulta', path: 'usuarios/ativos' }, { label: 'Usuarios' }],
        },
        canActivate: [Authorize],
      },
      {
      ...
      },
      {
        ...
        data: {
          roles: [Roles.boAdministrador, Roles.boOperacoes],
          breadcrumb: [{ label: 'Consulta', path: 'taxas' }, { label: 'Taxa' }],
        },
        canActivate: [Authorize],
      },
      {
