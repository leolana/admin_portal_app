...
export class FornecedorService {
    ...
    vincular(estabelecimentoId: number): Observable<any> {
        ...
        return this.http
            .post(`${environment.apiUrl}/fornecedor/${fornecedorId}/estabelecimento`, {
    ...
    alterarVinculo(vinculo: IVinculo) {
        const id = this.auth.user.participante;
        const url = `${environment.apiUrl}/fornecedor/${id}/estabelecimento/${vinculo.participante.id}/vinculo/alterar`;
    ...
    downloadExtrato(fornecedorId, reportId, file) {
        return this.http
            .get(`${environment.apiUrl}/participante/${fornecedorId}/extrato/${reportId}`, { responseType: 'blob' })
            .pipe(catchError(err => {
