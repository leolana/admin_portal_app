...
export class ExtratoDetalhadoComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        const [_, type] = location.href.match(/(estabelecimento|fornecedor)\/relatorio\/extratodetalhado$/);
        this.user = [type];
