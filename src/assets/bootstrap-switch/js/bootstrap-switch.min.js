      ...
      'keydown.bootstrapSwitch': function(z) {
        !z.which ||
          ...
          ((37 === z.which || 39 === z.which) &&
            (z.preventDefault(), z.stopImmediatePropagation(), x.state(39 === z.which)))
      },
    })
  }
  function l() {
  ...
  function m() {
    ...
    this.$label.on({
      ...
      'mouseup.bootstrapSwitch touchend.bootstrapSwitch': function(C) {
        if (y) {
          if (
            (C.preventDefault(), x.options.animate && x.$wrapper.addClass(h.call(x, 'animate')), z)
          ) {
      ...
      function x(y) {
        ...
        c(this, x),
          ...
          (this.$wrapper = u('<div>', {
            class: function() {
              return d(z.options, z.$element.attr('id'))
                ...
                .concat([z.options.baseClass], p.call(z, z.options.wrapperClass))
                .join(' ')
            },
          })),
          ...
          this.$element.on('switchChange.bootstrapSwitch', function() {
            ...
            !1 === z.options.onSwitchChange.apply(y, C) &&
              (z.$element.is(':radio')
        ...
        t(x, [
          ...
          },
          {
            ...
            value: function(z) {
              return 'undefined' == typeof z
                ...
                : (this.options.onColor && this.$on.removeClass(h.call(this, this.options.onColor)),
          ...
          },
          {
            ...
            value: function(z) {
              return 'undefined' == typeof z
                ...
                : (this.$label.html(z), f.call(this), (this.options.labelText = z), this.$element)
            },
          },
          {
            key: 'handleWidth',
            value: function(z) {
              return 'undefined' == typeof z
                ? this.options.handleWidth
                : ((this.options.handleWidth = z), f.call(this), g.call(this), this.$element)
            },
          },
          {
            key: 'labelWidth',
            value: function(z) {
              return 'undefined' == typeof z
                ...
                : ((this.options.labelWidth = z), f.call(this), g.call(this), this.$element)
            },
          },
          {
            key: 'baseClass',
          ...
          },
          {
            ...
            value: function(z) {
              ...
              return (
                this.$wrapper.removeClass(p.call(this, this.options.wrapperClass).join(' ')),
          ...
          },
          {
            ...
            value: function(z) {
              return 'undefined' == typeof z
                ? this.options.onInit
                : ((this.options.onInit = z || u.fn.bootstrapSwitch.defaults.onInit), this.$element)
            },
          },
          {
            key: 'onSwitchChange',
          ...
          },
          {
            ...
            value: function() {
              var z = this.$element.closest('form')
              return (
                z.length && z.off('reset.bootstrapSwitch').removeData('bootstrap-switch'),
                this.$container
                  .children()
                  .not(this.$element)
                  .remove(),
